...
@Component({
  selector: 'app-announcementhistory',
  templateUrl: './announcementhistory.component.html',
  styleUrl: './announcementhistory.component.scss',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule
...
export class AnnouncementHistoryComponent {
  ...
  constructor(
    private ref: MatDialogRef<AnnouncementHistoryComponent>,
