...
export class EditCbaPopupComponent implements OnInit {
  ...
  constructor(private router: Router, private ref: MatDialogRef<EditCbaPopupComponent>, private buildr: FormBuilder,) {
