...
@Component({
  selector: 'app-editccspopup',
  templateUrl: './editccspopup.component.html',
  styleUrl: './editccspopup.component.scss',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule
...
export class EditCcsPopupComponent {
  ...
  constructor(private router: Router, private ref: MatDialogRef<EditCcsPopupComponent>, private buildr: FormBuilder,) {
