...
@Component({
  selector: 'app-materialshistory',
  templateUrl: './materialshistory.component.html',
  styleUrl: './materialshistory.component.scss',
  standalone: true,
  imports: [
    FormsModule,
    CommonModule
...
export class MaterialsHistoryComponent {
